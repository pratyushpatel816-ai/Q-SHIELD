...
0.9583, precision of 1.0000, recall of
0.7500, F1 score of 0.8571, and false-positive
rate of 0.0000 at a detection threshold of 0.25.
...
showed an improvement in mean F1 score from 0.4703
for mismatch-only detection to 0.6463 for dual-signal
detection. The observed difference was 0.1760, with
an effect size of Cohen's d = 5.5290 within the evaluated
...
|---|---|---|
| Mean F1 Score | 0.4703 | 0.6463 |
| F1 Improvement | - | 0.1760 |
| Cohen's d | - | 5.5290 |
...
The best balanced configuration achieved an accuracy of
0.9583, precision of 1.0000, recall of
0.7500, F1 score of 0.8571, and a false-positive
rate of 0.0000.
...
with a mean F1 score difference of 0.1760 and
an observed effect size of Cohen's d = 5.5290.
